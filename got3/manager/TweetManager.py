'''
Taken from Eportet's fork of Jefferson Henrique's GetOldTweets

Link: https://github.com/eportet/GetOldTweets-python/blob/master/got/manager/TweetManager.py
